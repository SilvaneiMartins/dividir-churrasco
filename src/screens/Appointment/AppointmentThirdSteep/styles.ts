...
export const InputTextItem = styled.TextInput.attrs({
...
export const InputTextValor = styled.TextInput.attrs({
    placeholderTextColor: '#CCC',
})`
    width: ${RFValue(80)}px;
    height: ${RFValue(40)}px;
...
export const InputIconItem = styled(FontAwesome5)`
    font-size: ${RFValue(20)}px;
    padding: ${RFValue(8)}px;
`;

export const ButtonDeletar = styled(BorderlessButton)`
    padding: ${RFValue(5)}px;
`;

export const InputIconDeletar = styled(FontAwesome5)`
    font-size: ${RFValue(20)}px;
`;

export const InputContentViewRight = styled.View`
    align-items: center;
    flex-direction: row;
`;

export const InputContentViewLeft = styled.View`
    align-items: center;
    flex-direction: row;
`;

export const ContentButtonView = styled.View`
    align-items: stretch;
    justify-content: center;
`;

export const ButtonAddItem = styled(BorderlessButton)`
    width: 100%;
    padding: 13px 10px;
    align-items: center;
...
/**
 * Estilizazao Footer do componente;
 */
